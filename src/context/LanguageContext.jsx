...
const translations = {
  en: {
    ...
    hero: {
      ...
      cta2: 'View Our Work',
      trust: '5.0 rating · Trusted by clients across 3 countries',
      stats: ['Projects Delivered', 'Client Satisfaction', 'Faster Delivery', 'Support'],
      statValues: ['12+', '100%', '3×', '24/7'],
    },
    impactBar: {
      values: ['80K MAD+', '12+', '3', '< 14 days'],
      stats: [
    ...
    pricing: {
      ...
      plans: [
        {
          name: 'Starter', price: '2,500', period: 'oneTime',
        ...
        {
          name: 'Growth', price: '6,000', period: 'oneTime',
        ...
        {
          name: 'Scale', price: '10,000', priceNote: '+', period: 'startingFrom',
  ...
  fr: {
    ...
    hero: {
      ...
      trust: '5.0 de note · Approuvé par des clients dans 3 pays',
      stats: ['Projets livrés', 'Satisfaction client', 'Livraison plus rapide', 'Support'],
      statValues: ['12+', '100%', '3×', '24/7'],
    },
    impactBar: {
      values: ['80K MAD+', '12+', '3', '< 14 jours'],
  ...
  ar: {
    ...
    hero: {
      ...
      cta1: 'ابدأ مشروعك',
      cta2: 'شاهد أعمالنا',
      trust: 'تقييم 5.0 · موثوق من عملاء في 3 دول',
      stats: ['مشاريع منجزة', 'رضا العملاء', 'تسليم أسرع', 'دعم'],
      statValues: ['+12', '%100', '×3', '24/7'],
    },
    impactBar: {
      values: ['+80K MAD', '+12', '3', '< 14 يوم'],
